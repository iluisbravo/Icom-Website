...
const ModalAutorizarCotizacionComponent = (props) => {
    ...
    const autorizar = async () => {
        ...
        if (resultRevision.status === 200) {
            showAlert("Excelente", "La cotización se autorizo.", "success");
    ...
    return (
        <Styles>
            ...
            <Dialog
                ...
                fullWidth
            >
                <DialogTitle id="alert-dialog-title">{"Autorizar Cotización"}</DialogTitle>
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">

                        <Grid container spacing={1} className="text-center">
                            <Grid item xs={12} md={12}>
                                <h5 className="orange">¿Esta seguro de autorizar la Cotización?</h5>
                            </Grid>
...
export default ModalAutorizarCotizacionComponent;