...
const ModalRevisionCotizacionComponent = (props) => {
    ...
    const revision = async () => {
        ...
        if (resultRevision.status === 200) {
            showAlert("Excelente", "La cotización se mando a revisión.", "success");
    ...
    return (
        <Styles>
            ...
            <Dialog
                ...
                fullWidth
            >
                <DialogTitle id="alert-dialog-title">{"Enviar a Revisión Cotización"}</DialogTitle>
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">

                        <Grid container spacing={1} className="text-center">
                            <Grid item xs={12} md={12}>
                                <h5 className="orange">¿Esta seguro de enviar a revisión la Cotización?</h5>
                            </Grid>
...
export default ModalRevisionCotizacionComponent;