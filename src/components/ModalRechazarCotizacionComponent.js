...
const ModalRechazarCotizacionComponent = (props) => {
    ...
    const rechazar = async () => {
        ...
        if (resultRevision.status === 200) {
            showAlert("Excelente", "La cotización se rechazo.", "success");
    ...
    return (
        <Styles>
            ...
            <Dialog
                ...
                fullWidth
            >
                <DialogTitle id="alert-dialog-title">{"Rechazar Cotización"}</DialogTitle>
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">

                        <Grid container spacing={2} className="text-center">
                            <Grid item xs={12} md={12}>
                                <h5 className="orange">¿Esta seguro de rechazar la Cotización?</h5>
                            </Grid>
                            ...
                            <Grid item xs={12} md={12}>
                                <FormControl fullWidth>
                                    <TextField
                                        ...
                                        multiline
                                        rows={4}
                                        helperText="Escriba comentario del motivo del rechazo."
...
export default ModalRechazarCotizacionComponent;