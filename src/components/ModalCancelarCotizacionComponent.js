...
import { CircularProgress, FormControl, Grid, TextField } from '@material-ui/core';
...
const ModalCancelarCotizacionComponent = (props) => {
    ...
    const cancelar = async () => {
        ...
        if (resultRevision.status === 200) {
            showAlert("Excelente", "La cotización se canceló correctamente.", "success");
    ...
    return (
        <Styles>
            ...
            <Dialog
                ...
                fullWidth
            >
                <DialogTitle id="alert-dialog-title">{"Cancelar Cotización"}</DialogTitle>
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">

                        <Grid container spacing={2} className="text-center">
                            <Grid item xs={12} md={12}>
                                <h5 className="orange">¿Esta seguro de cancelar la Cotización?</h5>
                            </Grid>
                            ...
                            <Grid item xs={12} md={12}>
                                <FormControl fullWidth>
                                    <TextField
                                        ...
                                        multiline
                                        rows={4}
                                        helperText="Escriba comentario del motivo de la cancelación."
                                        onInput={onChangeComentario}
                                        value={comentario}
                                    />
                                </FormControl>
                            </Grid>
...
export default ModalCancelarCotizacionComponent;